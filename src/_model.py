...
from src._mmr import mmr
from src._maxsum import max_sum_distance
from src._highlight import highlight_document
from src.backend._base import BaseEmbedder
from src.backend._utils import select_backend
...
class KeyBERT:
    ...
    def __init__(
        ...
        Arguments:
            model: Use a custom embedding model or a specific src Backend.
    ...
    def extract_keywords(
        ...
        # Guided src either local (keywords shared among documents) or global (keywords per document)
